    ...
    <div class="content">
      ...
      <div class="card card-primary">
        ...
        <button type="button" class="btn btn-success btn-xs btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#staticBackdrop">
              <i class="fas fa-plus"> Add Admin </i>
            </button>
                  ...
                  while($row = mysqli_fetch_assoc($result)) 
                    {
                      ...
                      <tr>
                          ...
                          <td>'.$row['mobile'].'</td>
                          <td>'.$row['password'].'</td>
                          <td><img src='.$row['image'].' alt="admin_image" width="50px" height="50px;"></td>
                          <td>'.$row['status'].'</td>
                          <td>
      ...
      <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form method="POST" action="code.php" enctype='multipart/form-data' onsubmit="return validateForm1()" name="myform">
                  <div class="modal-body">
                          ...
                          <div class="form-group">
                              ...
                              <input name="mobile" class="form-control" placeholder="Enter Mobile Number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "11" required/>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                  <span class="input-group-text bg-primary" ><i class="fas fa-paperclip"></i></span>
                                </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="code.php" enctype='multipart/form-data'>
              <div class="modal-body">
                      ...
                      <div class="form-group">
                          ...
                          <div class="input-group">
                           ...
                           <input id="mobile" name="mobile" class="form-control" placeholder="Enter Mobile Number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "11" required/>
                          </div>
                      </div>
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                  <button type="submit" name="update_admin" class="btn btn-primary">Update Data</button>
              </div>
              </div>
            </form>
          </div>
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="code.php" >
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="delete_admin" class="btn btn-primary">YES! Delete it</button>
                </div>
                </div>
              </form>
            </div>
...
function validateForm1() {
  ...
  var y = document.forms["myform"]["C_password"].value;
  if (x !== y) {
