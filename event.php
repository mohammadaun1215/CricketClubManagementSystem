                  ...
                  while($row = mysqli_fetch_assoc($result)) 
                    {
                      ...
                      <tr>
                          ...
                          echo '<td><img src='.$row['image'].' alt="event_image" class="rounded mx-auto d-block" width="50px" height="50px;"></td>
                          <td>
                ...
                <form method="POST" action="code.php" enctype='multipart/form-data'>
                  <div class="modal-body">
                          ...
                          <div class="form-group ">
                              ...
                              <input type="text" class="form-control" name="title" placeholder="Enter Event Title"  required="true">
                              </div>
                          </div>
                          <div class="form-group">
                              <label>Date</label>
                              <div class="input-group">
                              <input type="datetime-local" class="form-control" name="date" placeholder="Enter Event Date"required="true">
                              </div>
                          </div>
                          <div class="form-group">
                              <label>Detail</label>
                              <div class="input-group">
                              <textarea class="form-control" name="detail" placeholder="Enter Event detail" rows="2" required="true"></textarea>
                              </div>
                          </div>
                          <div class="form-group">
                  ...
                  <div class="modal-footer">
                      ...
                      <button type="submit" name="insert_event" class="btn btn-primary">Save Data</button>
                  </div>
                  </div>
                </form>
              </div>
            ...
            <form method="POST" action="code.php" enctype='multipart/form-data'>
              <div class="modal-body">
                      ...
                      <div class="form-group">
                          <label>Detail</label>
                          <div class="input-group">
                           <textarea class="form-control" name="detail" id="detail" rows="2" required></textarea>
                          </div>
                      </div>
                      <div class="form-group">
                            <label>Ground Name</label>
                            <div class="input-group">
                              <select class="form-control" id="gname" name="gname" required="true">
                                 <option disabled selected>-- Select Ground Name --</option>
                                <?php
                              $result = mysqli_query($con,"select name from ground"); 
                              while($g = mysqli_fetch_array($result)) { 
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                  <button type="submit" name="update_event" class="btn btn-primary">Update Data</button>
              </div>
              </div>
            </form>
          </div>
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="code.php" >
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="delete_event" class="btn btn-primary">YES! Delete it</button>
                </div>
                </div>
              </form>
            </div>
