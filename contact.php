...
<div class="wrapper">
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4 ">
  ...
  <div class="content-wrapper">
                  ...
                  while($row = mysqli_fetch_assoc($result)) 
                    {
                      ...
                      <tr>
                          ...
                          <td>'.$row['message'].'</td>
                          <td>
                              <a class="btn btn-info btn-sm replybtn" href="#" ><i class="fas fa-reply"></i> Reply</a>
                          </td>';
                      echo'</tr>';
                        }
                    } 
   ...
   <!-- /.content-wrapper -->
       <!--###############################################################################################################-->
    <div class="modal fade" id="replymodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
              ...
              <form method="POST" action="code.php">
                  <div class="modal-body">
                          ...
                          <div class="form-group">
                              ...
                              <input type="email" disabled="true" class="form-control" id="ema">
                              </div>
                          </div>
                          <div class="form-group">
                              <label>Subject</label>
                              <div class="input-group">
                              <input name="subject" class="form-control" placeholder="Enter Email subject" type="text" required/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label>Detail</label>
                              <div class="input-group">
                              <textarea class="form-control" name="message" placeholder="Enter email body" rows="3" required="true"></textarea>
                              </div>
                          </div>
