    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="ground.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Available Grounds</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Ground</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      ...
      <div class="card card-warning">
        ...
        <button type="button" class="btn btn-success btn-xs btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#staticBackdrop">
              <i class="fas fa-plus"> Add Ground </i>
            </button>
                  ...
                  while($row = mysqli_fetch_assoc($result)) 
                    {
                      ...
                      <tr>
                          ...
                          <td><img src='.$row['image'].' alt="ground_image" width="50px" height="50px;"></td>
                          <td>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Ground</h5>
                ...
                <form method="POST" action="code.php" enctype='multipart/form-data'>
                  <div class="modal-body">
                          ...
                          <div class="form-group ">
                              ...
                              <input type="text" class="form-control" name="gname" placeholder="Enter Ground Name"  required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label>Location</label>
                              <div class="input-group">
                              <input type="text" class="form-control" name="location" placeholder="Enter Ground Location" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label>Capacity</label>
                              <div class="input-group">
                              <input name="capacity" class="form-control" placeholder="Enter Ground Capacity" type="number" required/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label>Booking Cost</label>
                              <div class="input-group">
                              <input type="number" class="form-control" name="cost" placeholder="Enter Booking Cost"required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label>Ground Description</label>
                              <div class="input-group">
                              <input type="text" class="form-control"  name="description" placeholder="Enter Ground Description" required>
                              </div>           
                          </div>
                          <div class="form-group">
                      ...
                      <div class="modal-footer">
                          ...
                          <button type="submit" name="insert_ground" class="btn btn-primary">Save Data</button>
                      </div>
                  </div>
                </form>
              </div>
  ...
  <!-- Update Modal -->
    ...
    <div class="modal fade" id="editmodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header bg-warning">
                <h5 class="modal-title" id="staticBackdropLabel">Update Ground</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
              </div>
            <form method="POST" action="code.php" enctype='multipart/form-data'>
              <div class="modal-body">
                    ...
                    <input type="hidden" name="update_id" id="update_id">
                      ...
                      <div class="form-group">
                          <label>Capacity</label>
                          <div class="input-group">
                           <input id="capacity" name="capacity" class="form-control" type="number" required/>
                          </div>
                      </div>
                      <div class="form-group">
                          <label>Booking Cost</label>
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                  <button type="submit" name="update_ground" class="btn btn-primary">Update Data</button>
              </div>
              </div>
            </form>
          </div>
   ...
   <!-- /.content-wrapper -->
    ...
    <div class="modal fade" id="deletemodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header bg-warning">
                  <h5 class="modal-title" id="staticBackdropLabel">Delete Ground</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
                </div>
              <form method="POST" action="code.php" >
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="delete_ground" class="btn btn-primary">YES! Delete it</button>
                </div>
                </div>
              </form>
            </div>
