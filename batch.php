    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="batch.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="card card-primary">
        ...
        <button type="button" class="btn btn-success btn-xs btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#staticBackdrop" >
              <i class="fas fa-plus"> Add Batch </i>
            </button>
            <!-- -->
        <button type="button" class="btn btn-success btn-xs btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#RD" style="margin-left: 10px">
              <i class="fas fa-info-circle"> Registration Detail </i>
            </button>
      ...
      <div class="modal fade" id="RD" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title" id="staticBackdropLabel">Registration Detail</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                  <div class="modal-body">
              <table id="myTable2" class="table table-striped table-bordered table-responsive text-nowrap" cellspacing="0" width="100%">
              <thead>
                  <tr>
                      <th>
                          #
                  ...
                  while($row = mysqli_fetch_assoc($result)) 
                    {
                      echo'<tr>';
                          ...
                          $id= $row['batch_id'];
                          $q2 = "select name from batch where batch_id='$id'";
                          $result2 = mysqli_query($con,$q2);
                          while ($d=mysqli_fetch_assoc($result2)) {
                            echo'<td>'.$d['name'].'</td>';
                          }
  ...
  <!-- ################################################################################################################################## -->
      ...
      <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Batch</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" action="code.php" enctype='multipart/form-data'>
                  <div class="modal-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                 <input type="time"  class="form-control" name="etime" required="true">
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <select class="form-control" name="gname" required="true">
                                 <option disabled selected>-- Select Ground Name --</option>
                                <?php
                              $result = mysqli_query($con,"select name from ground"); 
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-group">
                              <input min="1" type="number" class="form-control" name="seats" placeholder="Enter Number of seats" required="true">
                              </div>
                          </div>
                  <div class="modal-footer">
                      <button type="button" class="btn btn-danger" data-dismiss="modal" >Close</button>
                      <button type="submit" name="insert_batch" class="btn btn-primary">Save Data</button>
                  </div>
                  </div>
                </form>
              </div>
            ...
            <form method="POST" action="code.php" enctype='multipart/form-data'>
              <div class="modal-body">
                      ...
                      <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <label>Start time</label>
                                <div class="input-group">
                                 <input type="time"  class="form-control" name="stime" id="stime" required="true">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label>End time</label>
                                <div class="input-group">
                                 <input type="time"  class="form-control" name="etime" id="etime" required="true">
                                </div>
                              </div>
                            </div>
                      </div>
                      <div class="form-group">
                          <label>Ground Name</label>
                          <div class="input-group">
                           <input type="text" class="form-control" name="ground" id="ground" required="true" ></input>
                          </div>
                      </div>
                      <div class="form-group">
                          <label>No of seats</label>
                          <div class="input-group">
                           <input type="number" min="1" class="form-control" name="seats" id="seats" required="true"></input>
                          </div>
                      </div>
              <div class="modal-footer">
                  <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                  <button type="submit" name="update_batch" class="btn btn-primary">Update Data</button>
              </div>
              </div>
            </form>
          </div>
   ...
   <!-- /.content-wrapper -->
    ...
    <div class="modal fade" id="deletemodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header bg-primary">
                  <h5 class="modal-title" id="staticBackdropLabel">Delete Batch</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
                </div>
              <form method="POST" action="code.php" >
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="delete_batch" class="btn btn-primary">YES! Delete it</button>
                </div>
                </div>
              </form>
            </div>
