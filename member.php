          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-secondary">
                <h3 class="card-title">All register members</h3>
                  ...
                  while($row = mysqli_fetch_assoc($result)) 
                    {
                      ...
                      <td><img src='.$row['image'].' alt="member_image" width="50px" height="50px;"></td>
                      <td><a class="btn btn-danger btn-sm deletebtn" href="#"><i class="fas fa-trash"></i> Delete</a></td>
                      </tr>';
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="code.php" >
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="delete_member" class="btn btn-primary">YES! Delete it</button>
                </div>
                </div>
              </form>
            </div>
