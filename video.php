                ...
                <form method="POST" action="code.php" enctype='multipart/form-data'>
                  <div class="modal-body">
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-group">
                              <textarea class="form-control" name="detail" placeholder="Enter Video detail" rows="2" required="true"></textarea>
                              </div>
                          </div>
                          <div class="form-group">
                            <label>Video</label>
                  ...
                  <div class="modal-footer">
                      ...
                      <button type="submit" name="insert_video" class="btn btn-primary">Save Data</button>
                  </div>
                  </div>
                </form>
              </div>
            ...
            <form method="POST" action="code.php" enctype='multipart/form-data'>
              <div class="modal-body">
                      ...
                      <div class="form-group">
                          <label>Detail</label>
                          <div class="input-group">
                           <textarea class="form-control" name="detail" id="detail" rows="2" required="true"></textarea>
                          </div>
                      </div>
                      <div class="form-group">
                        <label>Image</label>
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                  <button type="submit" name="update_video" class="btn btn-primary">Update Data</button>
              </div>
              </div>
            </form>
          </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form method="POST" action="code.php" >
                ...
                <h4> Do you want to delete this Video ?</h4>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">NO</button>
                    <button type="submit" name="delete_video" class="btn btn-primary">YES! Delete it</button>
                </div>
                </div>
              </form>
            </div>
