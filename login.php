      ...
      <form action="code.php" method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" placeholder="Email"
           name="email" value="<?php if (isset($_COOKIE['emailcookie'])) {
        ...
        <div class="input-group mb-3">
          ...
          name="pass" value="<?php if (isset($_COOKIE['passwordcookie'])) {
        ...
        <div class="row">
          <div class="col-8">
            <div>
              <input type="checkbox" name="rememberme" <?php if (isset($_COOKIE['passwordcookie'])) {
            echo "checked"; }?> >
              <label>
                Remember Me
              </label>
